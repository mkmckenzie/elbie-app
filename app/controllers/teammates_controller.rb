class TeammatesController < ApplicationController
  ...
  private
    ...
    def teammate_params
      params.require(:teammate).permit(:name, :b, :primary_phone, :secondary_phone, :website, :instagram_handle, :visit_count, :venmo_handle, :facebook_page, :claimed_flag, :brand_summary)
    end
end
